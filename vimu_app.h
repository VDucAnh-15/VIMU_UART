...
#define VIMU_RING_BUFFER_SECONDS      10U
#define VIMU_REFILL_WATERMARK_SECONDS 3U
#define VIMU_TOTAL_SAMPLE_CAPACITY    (VIMU_RING_BUFFER_SECONDS * VIMU_TIMER_FILL_RATE_HZ)
#define VIMU_LOW_WATERMARK_SAMPLES    (VIMU_REFILL_WATERMARK_SECONDS * VIMU_TIMER_FILL_RATE_HZ)
#define VIMU_STATUS_PAYLOAD_SIZE      8U
#define VIMU_FIRMWARE_PROTOCOL_VERSION 3U
